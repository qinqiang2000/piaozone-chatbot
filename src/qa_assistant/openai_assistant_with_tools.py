...
class Assistant(BaseAssistant):
    ...
    def check_asst_file(self) -> bool:
        ...
        if not vector_store_ids:
            return False
        vector_files = self.client.vector_stores.files.list(vector_store_ids[0])
    ...
    def chat(self, session_id: str, content: str) -> str:
        ...
        vector_store_files = self.client.vector_stores.files.list(vector_store_id, filter="in_progress")
